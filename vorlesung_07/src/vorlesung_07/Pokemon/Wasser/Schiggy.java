...
public class Schiggy extends Pokemon {
    ...
    protected void takeDamage(int damage) {
        ...
        int currentHealth = this.getHealth(); // in variable zwischenspeichern, da kein direkter access möglich ist
        currentHealth -= damage - 1; // damage nehmen und einen abziehen, also statt 15 bspw.14
